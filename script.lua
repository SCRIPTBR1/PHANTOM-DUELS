...
-- ============================================================
--  BRANDING / THEME (PHANTOM DUELS - Preto/Branco/Cinza)
-- ============================================================
local PHANTOM_BRAND = "PHANTOM DUELS"
local PHANTOM_DISCORD = "PHANTOM DUELS"
local PHANTOM_COLORS = {
	...
	ICE = Color3.fromRGB(180,180,190),
...
refreshMobileButtonUi = function()
	...
	for _,data in pairs(mobileButtonFrames) do
		if data.stroke then
			...
			data.stroke.Color=editMobileButtons and Color3.fromRGB(255,255,255) or Color3.fromRGB(60,60,70)
		end
	end
...
local phantomAntiBatLockEnabled = false
local setPhantomAntiBatLockVisual = nil
local startAntiDie
...
local function updatePhantomStealBar(dt)
	...
	elseif recent then
		...
		targetColor=success and Color3.fromRGB(150,200,150) or Color3.fromRGB(200,150,150)
...
-- ============================================================
--  MOVEMENT SYSTEM (SEM RESET AUTOMÁTICO)
-- ============================================================
...
-- ============================================================
--  REMOVIDO O RESET AUTOMÁTICO AO ANDAR
-- ============================================================
-- O código que causava o reset foi removido completamente.
-- As funções abaixo mantêm as outras funcionalidades sem interferir no movimento normal.
...
startAutoLeft = function()
	...
	alConn=RunService.Heartbeat:Connect(function()
		...
		elseif alPhase==2 then
			...
			if (tgt-hrp.Position).Magnitude<1 then
				hum:Move(Vector3.zero,false);hrp.Velocity=Vector3.zero				autoLeftEnabled=false;if alConn then alConn:Disconnect();alConn=nil end
...
setupSpeedIndicator = function(char,player)
	...
	if player==LP then
		...
		tag.Text="PHANTOM DUELS";tag.TextColor3=Color3.fromRGB(255,255,255)
		...
		tagGrad.Color=ColorSequence.new(PHANTOM_COLORS.ICE,PHANTOM_COLORS.ACCENT)
		tagGrad.Rotation=0
	end
	...
	val.Text=player==LP and "Speed: 0.0" or "0";val.TextColor3=player==LP and Color3.fromRGB(255,255,255) or PHANTOM_COLORS.ICE
	...
	if player==LP then
		...
		valGrad.Color=ColorSequence.new(PHANTOM_COLORS.ACCENT,PHANTOM_COLORS.ICE)
		valGrad.Rotation=0
		speedLabel=val
	else
...
refreshBatMotionAntiDieGuard=function()
	batMotionAntiDieGuard=(phantomAntiBatLockEnabled or autoBatEnabled) and true or false
	if batMotionAntiDieGuard then
		if startAntiDie then startAntiDie() end
...
local function setupHitCountdownBillboard(char)
	...
	grad.Color = ColorSequence.new(PHANTOM_COLORS.ACCENT,PHANTOM_COLORS.ICE)
	grad.Rotation = 0
...
task.spawn(function()
	...
	stGrad.Color = ColorSequence.new(PHANTOM_COLORS.ACCENT, PHANTOM_COLORS.ICE)
	stGrad.Rotation = 0
	...
	labelGrad.Color = ColorSequence.new(PHANTOM_COLORS.ACCENT, PHANTOM_COLORS.ICE)
...
local function saveConfig()
	...
	local cfg={
		...
		phantomAntiBatLock=phantomAntiBatLockEnabled,
...
local function playPhantomIntro(gui,main,miniBtn)
	...
	loading.Size=UDim2.new(0,520,0,18);loading.Position=UDim2.new(0.5,-260,0.5,72);loading.BackgroundTransparency=1;loading.Text=PHANTOM_DISCORD;loading.TextColor3=PHANTOM_COLORS.SECONDARY;loading.Font=Enum.Font.GothamBold;loading.TextSize=11;loading.TextTransparency=1;loading.TextXAlignment=Enum.TextXAlignment.Center;loading.ZIndex=201
	...
	local barGrad=Instance.new("UIGradient",bar);barGrad.Color=ColorSequence.new(PHANTOM_COLORS.ACCENT,PHANTOM_COLORS.ICE)
...
local function buildGui()
	...
	local PURPLE=PHANTOM_COLORS.PURPLE
	...
	local function buildInstaResetPanel()
		...
		title.Size=UDim2.new(1,-78,0,28);title.Position=UDim2.new(0,22,0,18);title.BackgroundTransparency=1;title.Text="PHANTOM INSTA RESET";title.TextColor3=Color3.fromRGB(255,255,255);title.Font=Enum.Font.GothamBlack;title.TextSize=17;title.TextXAlignment=Enum.TextXAlignment.Left;title.ZIndex=62
		...
		disc.Text="PHANTOM DUELS";disc.TextColor3=Color3.fromRGB(255,255,255);disc.Font=Enum.Font.GothamBold;disc.TextSize=11;disc.TextXAlignment=Enum.TextXAlignment.Center;disc.ZIndex=61
	...
	ttl.BackgroundTransparency=1;ttl.Text=PHANTOM_BRAND;ttl.TextColor3=Color3.fromRGB(255,255,255);ttl.Font=Enum.Font.GothamBlack;ttl.TextSize=IsMobile and 14 or 17;ttl.TextXAlignment=Enum.TextXAlignment.Left
	...
	sub.BackgroundTransparency=1;sub.Text=PHANTOM_DISCORD;sub.TextColor3=Color3.fromRGB(255,255,255);sub.Font=Enum.Font.GothamMedium;sub.TextSize=IsMobile and 9 or 10;sub.TextXAlignment=Enum.TextXAlignment.Left
	...
	local lockStroke=Instance.new("UIStroke",lockBtn);lockStroke.Color=Color3.fromRGB(180,180,190);lockStroke.Thickness=1;lockStroke.Transparency=0.34
	local lockStrokeGrad=Instance.new("UIGradient",lockStroke)
	lockStrokeGrad.Color=ColorSequence.new(Color3.fromRGB(140,140,160),Color3.fromRGB(120,120,140))
...
local function buildMobileButtons()
	...
	ebGrad.Color=ColorSequence.new(PHANTOM_COLORS.ACCENT,PHANTOM_COLORS.ICE)
	ebGrad.Rotation=0
	...
	local function makeBtn(id,label,col,row,defaultLabel)
		...
		bgGrad.Color=ColorSequence.new(PHANTOM_COLORS.ACCENT,PHANTOM_COLORS.ICE)
		bgGrad.Rotation=0
		...
		strokeGrad.Color=ColorSequence.new(PHANTOM_COLORS.ACCENT,PHANTOM_COLORS.ICE)
	...
	RunService.Heartbeat:Connect(function(dt)
		...
		local function setActive(id,active)
			...
			data.label.TextColor3 = PHANTOM_COLORS.TEXT:Lerp(Color3.fromRGB(15,5,25), intensity)
