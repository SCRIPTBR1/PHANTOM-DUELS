--[[PHANTOM DUELS - Menu ribassato, barra furto bianca, pulsanti mobili trascinabili singolarmente]]
...
M.MOB_POS_FILE = "phantomduels_btnpos.json"
M.MOVE_KEYS = {
    [Enum.KeyCode.W]=true,
    [Enum.KeyCode.A]=true,
    [Enum.KeyCode.S]=true,
...
function M.buildMobileButtons()
    ...
    local CORNER_R = 4 -- quadrati con punte leggermente curvate
    ...
    local accent = UI_ACCENT or CHERRY_ACCENT or Color3.fromRGB(255, 255, 255)
    local BTN_OFF   = UI_BTN_BG or UI_ROW_BG or Color3.fromRGB(20, 20, 20)
    local BTN_ON    = Color3.fromRGB(255, 255, 255)
    local TXT_OFF   = Color3.fromRGB(200, 200, 200)
...
-- CONFIG SAVE/LOAD
-- ============================================================
local CHERRY_CONFIG_NAME = "PhantomConfig.json"
...
function M.applyCustomBackground(frame)
    ...
    if id <= 0 then
        -- Default background: dark anime girl
        id = 6311243701
        M.customBgId = id
    end
...
print("PHANTOM DUELS loaded successfully!")
return M
